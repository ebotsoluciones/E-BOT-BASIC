...
def procesar(numero, body, resp):
    ...
    if estado == "ADMIN_NUEVO_NOMBRE":
        ...
        msg.body("Teléfono del paciente (549XXXXXXXXXX)")
    ...
    if estado == "ADMIN_NUEVO_TEL":
        ...
        set_user_state(numero, "adm_tel", tel)
...
def _iniciar_mensaje(numero, msg):
    ...
    msg.body(
        "Escribí tu mensaje y lo recibiremos a la brevedad."
    )
...
def _flujo_turno_fecha(numero, body, msg):
    ...
    try:
        ...
        msg.body(
            "❌ Formato inválido. Ingresá dd/mm/yyyy"
        )
    ...
    if fecha < datetime.now().date():
        ...
        msg.body(
            "❌ La fecha ya pasó. Ingresá una fecha futura."
        )
...
def _flujo_turno_hora(numero, body, msg):
    ...
    if hora is None or hora not in generar_horarios():
        ...
        msg.body(
            "❌ Hora inválida. Elegí un horario de la lista."
        )
...
def manejar_admin(numero, body, msg):
    ...
    if body == "5":
        ...
        msg.body(
            "Fecha del turno a cancelar (dd/mm/yyyy)"
        )
...
def _flujo_bloquear_hora(numero, body, msg):
    ...
    if body.strip().lower() == "todos":
        ...
        msg.body(
            f"✅ Día {fecha} bloqueado completo."
        )
